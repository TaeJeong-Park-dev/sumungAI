...
st.set_page_config(
    ...
    page_icon="/Users/parktaejung/Desktop/WorkSpace/software_project/molla/소프젝/수뭉2.png",  # 이미지 파일 경로
    layout="wide"
)
st.title("AI 수뭉 💬")
...
with st.sidebar:
    st.image("/Users/parktaejung/Desktop/WorkSpace/software_project/molla/소프젝/수뭉1.png", width=200)
...
if user_input := st.chat_input("메시지를 입력해 주세요."):
    ...
    with st.chat_message("assistant"):
        ...
        # 모델 생성
        GPT_4o = ChatOpenAI(model="gpt-4o", streaming=True, callbacks=[stream_handler])
        ...
        vector_store_path = "/Users/parktaejung/Desktop/WorkSpace/software_project/molla/소프젝/vector_store"
        ...
        prompt = ChatPromptTemplate.from_messages(
            [
                ("system", 
                 """
                    역할: 너는 반말로 말을 하는 상명대학교 학생들의 학교 생활을 도와줄 도우미야.
                    이름: 너의 이름은 '수뭉'이야.
